...
private:
	...
	void OnTimerTickSelect(wxTimerEvent& e);
	void OnTimerTickCheck(wxTimerEvent& e);
	void OnTimerTickWrite(wxTimerEvent& e);
	void OnTimerTickRadio(wxTimerEvent& e);
	void OnTimerTickGauge(wxTimerEvent& e);
...
private:
	...
	int width = 0;
	int height = 0;
	unsigned long long m_time_limit = 0;
	...
	wxButton* m_inc_gauge_btn = nullptr;
	wxButton* m_dec_gauge_btn = nullptr;
	wxTextCtrl* m_gauge_lvl = nullptr;
	...
	bool m_inc_gauge = true;
	CpuUsageReader m_cpu_reader;
	int m_accumulate_cpu_usage = 0;
